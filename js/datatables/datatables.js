 ...
 *   https://datatables.net/download/#dt/dt-2.0.7/cr-2.0.2/fc-5.0.0/r-3.0.2/sc-2.4.2/sp-2.3.1/sl-2.0.1
 *
 * Included libraries:
 *   DataTables 2.0.7, ColReorder 2.0.2, FixedColumns 5.0.0, Responsive 3.0.2, Scroller 2.4.2, SearchPanes 2.3.1, Select 2.0.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.0.7/cr-2.0.2/fc-5.0.0/r-3.0.2/sc-2.4.2/sp-2.3.1/sl-2.0.1",
